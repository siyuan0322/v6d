...
type LocalObjectInformer interface {
	...
	Lister() v1beta1.LocalObjectLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.K8sV1beta1().LocalObjects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.K8sV1beta1().LocalObjects(namespace).Watch(context.TODO(), options)
			},
		},
		&k8sv1beta1.LocalObject{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *localObjectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&k8sv1beta1.LocalObject{}, f.defaultInformer)
}

func (f *localObjectInformer) Lister() v1beta1.LocalObjectLister {
	return v1beta1.NewLocalObjectLister(f.Informer().GetIndexer())
}
