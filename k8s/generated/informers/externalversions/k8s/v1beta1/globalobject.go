...
import (
	...
	versioned "github.com/alibaba/v6d/k8s/generated/clientset/versioned"
	internalinterfaces "github.com/alibaba/v6d/k8s/generated/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/alibaba/v6d/k8s/generated/listers/k8s/v1beta1"
...
type GlobalObjectInformer interface {
	...
	Lister() v1beta1.GlobalObjectLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.K8sV1beta1().GlobalObjects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.K8sV1beta1().GlobalObjects(namespace).Watch(context.TODO(), options)
			},
		},
		&k8sv1beta1.GlobalObject{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *globalObjectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&k8sv1beta1.GlobalObject{}, f.defaultInformer)
}

func (f *globalObjectInformer) Lister() v1beta1.GlobalObjectLister {
	return v1beta1.NewGlobalObjectLister(f.Informer().GetIndexer())
}
