...
type GlobalObjectLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.GlobalObject, err error)
...
// List lists all GlobalObjects in the indexer.
func (s *globalObjectLister) List(selector labels.Selector) (ret []*v1beta1.GlobalObject, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.GlobalObject))
	})
	return ret, err
}
...
type GlobalObjectNamespaceLister interface {
	...
	Get(name string) (*v1beta1.GlobalObject, error)
...
// List lists all GlobalObjects in the indexer for a given namespace.
func (s globalObjectNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.GlobalObject, err error) {
...
// Get retrieves the GlobalObject from the indexer for a given namespace and name.
func (s globalObjectNamespaceLister) Get(name string) (*v1beta1.GlobalObject, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("globalobject"), name)
	}
	return obj.(*v1beta1.GlobalObject), nil
}
