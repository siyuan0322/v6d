...
type LocalObjectLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.LocalObject, err error)
...
// List lists all LocalObjects in the indexer.
func (s *localObjectLister) List(selector labels.Selector) (ret []*v1beta1.LocalObject, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.LocalObject))
	})
	return ret, err
}
...
type LocalObjectNamespaceLister interface {
	...
	Get(name string) (*v1beta1.LocalObject, error)
...
// List lists all LocalObjects in the indexer for a given namespace.
func (s localObjectNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.LocalObject, err error) {
...
// Get retrieves the LocalObject from the indexer for a given namespace and name.
func (s localObjectNamespaceLister) Get(name string) (*v1beta1.LocalObject, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("localobject"), name)
	}
	return obj.(*v1beta1.LocalObject), nil
}
